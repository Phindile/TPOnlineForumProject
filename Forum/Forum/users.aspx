<%@ Page Title="" Language="C#" MasterPageFile="~/Content/ForumMaster.Master" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="ForumTP.users" %>
...
<asp:Repeater id="rptRecent" runat="server" EnableViewState="false">
	...
	<ItemTemplate>
		<tr>
		<td><a href='viewprofile.aspx?UserID=<%# Eval("UserID") %>'><img src='<%# ForumTP.Utility.User.GetAvatarFileName(Eval("AvatarFileName")) %>' width="25" height="25" /></a></td>
