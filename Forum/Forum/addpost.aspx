<%@ Page Title="" Language="C#" MasterPageFile="~/Content/ForumMaster.Master" AutoEventWireup="true" CodeBehind="addpost.aspx.cs" Inherits="ForumTP.addpost" %>
<%@ Import Namespace="ForumTP.Resources" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AspNetForumContentPlaceHolder" runat="server">
    <div class="location">
<h2>
	<%= ForumTP.Resources.various.AddMessage %>:
	...
	<div class="richeditor">
		<div class="editbar" id="divEditbar" runat="server" enableviewstate="false">
			...
			<span id="divSmilies" style="DISPLAY:none;position:absolute;border:1px solid slategray;background:#ffffff;padding: 5px 5px 5px 5px">
				...
				<br />
				<a href="javascript:void(0)" onclick="OpenMoreSmilies()"><%= ForumTP.Resources.various.MoreSmilies %></a>
			</span>
...
<asp:Label ID="lblFileSizeError" runat="server" ForeColor="red" Visible="false" EnableViewState="false"><%= ForumTP.Resources.various.MaxAttachSize %></asp:Label>
...
<span id="spanUtils" runat="server" enableviewstate="false">
	...
	&nbsp;&nbsp;&nbsp;
	<button type="button" id="btnPreview" runat="server" enableviewstate="false" class="greybutton" onclick="wswgEditor.doCheck();ShowPreview(); return false;"><%= ForumTP.Resources.various.Preview %></button>
	<button class="greybutton" onclick="history.back()" type="button"><%= ForumTP.Resources.various.Cancel %></button>
</span>
...
<HeaderTemplate>
	...
	<%= ForumTP.Resources.various.Attachments %><br />
</HeaderTemplate>
<ItemTemplate>
...
<div id="divFiles" runat="server">
	<br />
	<a href="javascript:void(0)" onclick="javascript:OpenFiles()"><%= ForumTP.Resources.various.AttachFiles %></a>
...
<div id="divPolls" runat="server">
	...
	<a href="javascript:void(0)" onclick="OpenPolls()">
		<%= ForumTP.Resources.various.CreateAPoll %>
	</a>
	<div id="divPollsContainer" style="DISPLAY:none;">
		<table id="tblOptions" class="roundedborder noborder gray" cellpadding="11" style="margin-bottom:5px">
			<tr><td align="right"><b><%= ForumTP.Resources.various.PollQuestion %></b>:</td>
			<td><asp:TextBox ID="tbPollQuestion" MaxLength="255" Columns="80" runat="server"></asp:TextBox></td></tr>
			<tr><td align="right"><%= ForumTP.Resources.various.PollOption %>:</td>
			<td><input type="text" size="80" maxlength="255" name="PollOption0" /></td></tr>
		</table>
		<button onclick="javascript:AddOptionInput();" type="button"><%= ForumTP.Resources.various.AddAnOption %></button>
		<button onclick="javascript:ClearPoll();" type="button" class="gradientbutton"><%= ForumTP.Resources.various.Cancel %></button>
	</div>
</div>
<br />
...
<asp:Repeater ID="rptMessages" runat="server">
	<HeaderTemplate>
		<br /><br />
		<%= ForumTP.Resources.various.PreviousMessagesInTopic %>
	...
	<ItemTemplate>
		...
		<td><%# ForumTP.Utility.Formatting.FormatMessageHTML(Eval("Body").ToString())%></td></tr>
	</ItemTemplate>
