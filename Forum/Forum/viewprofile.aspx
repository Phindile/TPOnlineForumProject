<%@ Page Title="" Language="C#" MasterPageFile="~/Content/ForumMaster.Master" AutoEventWireup="true" CodeBehind="viewprofile.aspx.cs" Inherits="ForumTP.viewprofile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AspNetForumContentPlaceHolder" runat="server">
	...
	<div class="usertools">
		...
		<% if(ForumTP.Utility.User.CurrentUserID!=0 && ForumTP.Utility.Settings.EnablePrivateMessaging) { %>
