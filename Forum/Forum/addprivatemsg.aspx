<%@ Page Title="" Language="C#" MasterPageFile="~/Content/ForumMaster.Master" AutoEventWireup="true" CodeBehind="addprivatemsg.aspx.cs" Inherits="ForumTP.addprivatemsg" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="editor.css" rel="Stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="AspNetForumContentPlaceHolder" runat="server">
    <div class="location">
	<h2><%= ForumTP.Resources.various.SendAPrivateMessage %> - <%= ForumTP.Utility.User.GetUserNameById(toUserID) %></h2></div>
	...
	<div id="divMain" runat="server">
		...
		<asp:button CssClass="gradientbutton" id="btnSave" runat="server" onclick="btnSave_Click" OnClientClick="wswgEditor.doCheck();return true;" Font-Bold="true" Text="<%# ForumTP.Resources.various.SendMessage %>"></asp:button>
		<span class="gray">(ctrl+enter)</span>
		&nbsp;&nbsp;&nbsp;
		<button type="button" class="gradientbutton" onclick="wswgEditor.doCheck();ShowPreview(); return false;"><%= ForumTP.Resources.various.Preview %></button>
		<button type="button" onclick="history.back()" class="gradientbutton"><%= ForumTP.Resources.various.Cancel %></button>
		
		<div id="divFiles" runat="server">
			<br />
			<a href="javascript:OpenFiles()"><%= ForumTP.Resources.various.AttachFiles %></a>
	...
	<asp:Label ID="lblError" runat="server" ForeColor="red" Font-Bold="true" Visible="false" EnableViewState="false"><%= ForumTP.Resources.various.UserNotFoundOrYouLoggedOut %></asp:Label>
